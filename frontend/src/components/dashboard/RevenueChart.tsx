...
export default function RevenueChart() {
  ...
  return (
    <div className="card space-y-5">
      ...
      {/* Total */}
      <div className="text-center py-5 rounded-xl relative overflow-hidden"
        style={{
          background: 'linear-gradient(135deg, rgba(99,102,241,0.06), rgba(139,92,246,0.03))',
          border: '1px solid rgba(99,102,241,0.08)',
        }}>
        <p className="stat-number gradient-text">{revenue.total}</p>
        <p className="text-[11px] text-slate-500 mt-1 font-medium">Total INIT Earned</p>
      </div>
      ...
      <div className="flex items-center gap-2 p-3 rounded-xl"
        ...
        <svg className="w-3.5 h-3.5 text-indigo-400/60 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
